...
Bioinformatics_data = pd.DataFrame({
    "Platform Name": ["K_Base", "Nephele", "MG_Rast", "Geneious", "Galaxy"],
    "Run Date": pd.date_range(start="2025-01-01", periods=5),
})
...
elif data_option == "Bioinformatics Data":
    st.write("### Bioinformatics Data")
    st.dataframe(Bioinformatics_data)
